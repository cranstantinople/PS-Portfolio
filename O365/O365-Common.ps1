...
$O365.Service.SharePoint = @{}
$O365.Service.SharePoint.Name = "SharePoint PnP"
$O365.Service.SharePoint.Module = @{}
$O365.Service.SharePoint.Module.Name = "SharePointPnPPowerShellOnline"
...
Function O365-GetAddresses {
    ...
    If ($O365.Exchange.Addresses.Types.Values.All){
        ...
        Write-Host "[U]pdate from Office 365 or Use [E]xisting? ( [U]pdate / [E]xisting )"
